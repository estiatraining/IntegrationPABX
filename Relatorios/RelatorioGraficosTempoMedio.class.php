...
class RelatorioGraficosTempoMedio extends Utilitarios implements RelatorioNegociosInterface {
    public function __construct(){}
    public function gerarGraficosTempoMedio($_dateIni, $_dateFim, $_timeIni , $_timeFim , $_ramal){
        if(file_exists($_SERVER[ 'DOCUMENT_ROOT' ]."/System/IMG/grafico02.png"))
            unlink($_SERVER[ 'DOCUMENT_ROOT' ]."/System/IMG/grafico02.png");
        ...
        $PHPlot->SetTitle( utf8_decode("Quantidade de Chamadas por hora." ));
        ...
        $quantidade = array();
        while ($row = $DadosFiltradosDao->resultObject($result['totalLigacoesHora'])) {
        ...
        $PHPlot->output_file = $_SERVER[ 'DOCUMENT_ROOT' ]."/System/IMG/grafico02.png";
